...
<p align="center">
  <img src="https://github.com/DennisOndieki/AML_2019_Group4/blob/master/Images/min_loss_freq1.png" width="600" height="480">
<br> The function attained the global minimum 50% of the time and converged at other minima the rest of the time
<br> The number of iterations need for the function to converge also decreased with an increase in the step size as highlighted below:
<p align="center">
